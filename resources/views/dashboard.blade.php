...
@if (session()->has('success'))
        <div class="alert alert-primary alert-dismissible fade show" role="alert">
            ...
            </svg> {{ session('success') }} {{ auth()->user()->name }}! Kehadiran Anda adalah kebahagiaan bagi kami!
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-6">
                <div class="small-box bg-danger shadow" style="border-radius: 7px">
                    <div class="inner">
                        <h3>{{ $hitungkategori }}
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning shadow" style="border-radius: 7px">
                    <div class="inner">
                        <h3>{{ $hitungproduct }}
                            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" fill="currentColor" class="bi bi-box-seam-fill" viewBox="0 0 16 16">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success shadow" style="border-radius: 7px">
                    <div class="inner">
                        <h3>{{ $hitungtransaksi }}
                    ...
                    <a href="/transaction" class="small-box-footer">
                        Lihat detail
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
                            <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
                          </svg>
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-primary shadow" style="border-radius: 7px">
                    <div class="inner">
                        <h3>{{ $hitungusers }}
                        ...
                        <p>Total User / Member</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-person-add"></i>
                    </div>
                    <a href="/usermember" class="small-box-footer">
                        Lihat detail
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
                            <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
                          </svg>
