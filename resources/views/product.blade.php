    ...
    <table class="table table-bordered">
        ...
        @foreach ($barang as $brg)
            <tr>
                ...
                <td>{{ $brg->name_product }}</td>
                <td>{{ $brg->harga }}</td>
                <td>{{ $brg->description }}</td>
                <td>{{ $brg->stock }}</td>
                <td>{{ $brg->barang->nama_kategori }}</td>
                <td>
                    <form action="/product/{{ $brg->id }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
                    ...
                    <a href="product/{{ $brg->id }}/edit" style="text-decoration: none;">
                        <button class="btn btn-warning">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor"
                    ...
                    <a href="/product/{{ $brg->id }}" style="text-decoration: none;">
