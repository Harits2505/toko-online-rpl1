...
<hr>
    <div class="container">
        ...
        <form action="/product/{{ $databarang->id }}" method="post">
            @csrf
            @method('PUT')
            <table>
                <tr>
                    ...
                    <td>
                        <div class="input-group flex-nowrap w-100">
                            ...
                            <input type="text" class="form-control" placeholder="Masukan produk" aria-label="Username"
                                ...
                                name="name_product" value="{{ $databarang->name_product }}" required>
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        <div class="input-group flex-nowrap w-100">
                            ...
                            <input type="text" class="form-control" placeholder="Masukan deskripsi" aria-label="Username"
                                ...
                                value="{{ $databarang->description }}" required>
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        <div class="input-group flex-nowrap w-100">
                            ...
                            <input type="text" class="form-control" placeholder="Masukan stok" aria-label="Username"
                                ...
                                value="{{ $databarang->stock }}" required>
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="kategori_id" id="inputGroupSelect01"
                                value="{{ $databarang->kategori_id }}" required>
                                <option selected>Pilih kategori...</option>
                                @foreach ($kategori as $ktgri)
                                    <option value="{{ $ktgri->id }}" {{ $ktgri->id == $databarang->kategori_id }}>
                                        {{ $ktgri->nama_kategori }}</option>
                                @endforeach
                            </select>
                        </div>
                    </td>
