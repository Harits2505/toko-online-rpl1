                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control w-50" placeholder="Masukan nama" aria-label="Username"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="file" value="{{ auth()->user()->img }}" name="files" class="form-control">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-warning" href="/profileuser/{{ auth()->user()->id }}/edit">
